  ...
  provisioner "local-exec" {
    command = <<-EOT
      ...
      do_task() {
        ...
        --rsync-path="mkdir -p /home/master/gcp_backups/.conf /home/master/gcp_backups/.backup_info /home/master/gcp_backups/logs && rsync" \
        $dir/.tf-sa-identity.json $sshUser@$srvIP:/home/master/gcp_backups/.conf/tf-sa-identity.json
        ...
        chmod 600 /home/master/gcp_backups/.conf/tf-sa-identity.json
        chmod +x /home/master/gcp_backups/backup_script.sh
        ...
        source ~/.bashrc
        echo "*/30 * * * * . /etc/profile && bash /home/master/gcp_backups/backup_script.sh" | crontab -
        ###############################################################################################
EOF
